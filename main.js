(function () {
  ...
  // Asynchronous chunked generation – no more freeze
  ...
  function renderMembersTab(showAll = false) {
    ...
    // Normal 80‑member view
    let html = `<div style="padding:10px;font-weight:700;color:var(--gold);border-bottom:1px solid var(--gold);margin-bottom:8px;">👥 Community Members (${memberList.length} of ${TOTAL_MEMBERS} online now)</div>`;
  ...
  function initApp() {
    ...
    renderTransactions();
    bindEvents();
    // Start building the full member list asynchronously in the background – no freeze
